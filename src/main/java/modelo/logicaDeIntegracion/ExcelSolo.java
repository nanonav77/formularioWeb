...
public class ExcelSolo {
	...
	public ExcelSolo(int pcedula) throws ClassNotFoundException, SQLException{
	...
	public DefaultTableModel getPersonal() throws ClassNotFoundException, SQLException{
		...
		return instancia.getPersonalIndividual(new DefaultTableModel(), this.cedula);
	...
	public DefaultTableModel getAcademica() throws ClassNotFoundException, SQLException{
		MySQL instancia = Singleton_MySQL.getInstancia();
		return instancia.getInfoAcademicaSolo(new DefaultTableModel(), this.cedula);
	...
	public DefaultTableModel getProfesional() throws ClassNotFoundException, SQLException{
		MySQL instancia = Singleton_MySQL.getInstancia();
		return instancia.getInfoProfesionalSolo(new DefaultTableModel(), this.cedula);
	...
	public static void main (String [ ] args) throws IOException, ClassNotFoundException, SQLException {
		...
		ExcelSolo ex = new ExcelSolo(304900948);
