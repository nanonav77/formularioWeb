...
s_a[142]="Alifu|Baa|Dhaalu|Faafu|Gaafu habilitarInformacionAcademica(this);Alifu|Gaafu Dhaalu|Gnaviyani|Haa Alifu|Haa Dhaalu|Kaafu|Laamu|Lhaviyani|Maale|Meemu|Noonu|Raa|Seenu|Shaviyani|Thaa|Vaavu";
...
function populateStates(){
	...
	if (document.getElementById('ult-titulo1').value.length == 0 && document.getElementById('univ-titulo1').value.length==0 && document.getElementById('ano-titulo1').value.length==0){
		document.getElementById('ult-titulo2').disabled = true;
	    document.getElementById('univ-titulo2').disabled = true;
		document.getElementById('pais-univ2').disabled = true;
		document.getElementById('ano-titulo2').disabled = true;	
	}
	if (document.getElementById('ult-titulo2').value.length == 0 && document.getElementById('univ-titulo2').value.length==0 && document.getElementById('ano-titulo2').value.length==0){
		document.getElementById('ult-titulo3').disabled = true;
	    document.getElementById('univ-titulo3').disabled = true;
		document.getElementById('pais-univ3').disabled = true;
		document.getElementById('ano-titulo3').disabled = true;	
	}
	if (document.getElementById('insti1').value.length == 0 && document.getElementById('depart1').value.length==0 && document.getElementById('ano-inicio-act1').value.length==0){
		document.getElementById('insti2').disabled = true;
	    document.getElementById('depart2').disabled = true;
		document.getElementById('ano-inicio-act2').disabled = true;
	
	}
	if (document.getElementById('insti2').value.length == 0 && document.getElementById('depart2').value.length==0 && document.getElementById('ano-inicio-act2').value.length==0){
		document.getElementById('insti3').disabled = true;
	    document.getElementById('depart3').disabled = true;
		document.getElementById('ano-inicio-act3').disabled = true;
...
function populateCountries(countryElementId, stateElementId){
	...
	var paisGuardado = document.getElementById(countryElementId).value;
	
	countryElement.length=0;
	
	if (paisGuardado.toString().length==0){
		paisGuardado = 'Costa Rica';
	}

	countryElement.options[0] = new Option(paisGuardado.toString(),paisGuardado.toString());
